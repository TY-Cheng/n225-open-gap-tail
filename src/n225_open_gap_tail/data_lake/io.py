...
JQUANTS_SILVER_SCHEMA = ParquetSchema(
    ...
    columns=(
        ...
        ("day_session_high", pl.Float64),
        ("day_session_low", pl.Float64),
        ("day_session_close", pl.Float64),
        ("night_session_open", pl.Float64),
        ("night_session_high", pl.Float64),
        ("night_session_low", pl.Float64),
        ...
        ("invalid_day_session_high", pl.Boolean),
        ("invalid_day_session_low", pl.Boolean),
        ("invalid_day_session_close", pl.Boolean),
        ("invalid_night_session_open", pl.Boolean),
        ("invalid_night_session_high", pl.Boolean),
        ("invalid_night_session_low", pl.Boolean),
...
JQUANTS_OPTIONS_BRONZE_SCHEMA = ParquetSchema(
    name="jquants_nikkei225_options_daily_bronze",
    version=2,
    columns=(
        ("Date", pl.Utf8),
        ("Code", pl.Utf8),
    ...
    required_columns=("Date", "Code", "requested_date", "research_download_ts_utc"),
)

JQUANTS_OPTIONS_SILVER_SCHEMA = ParquetSchema(
    name="jquants_nikkei225_options_daily_silver",
    version=2,
    columns=(
        ("trading_date", pl.Utf8),
        ("option_code", pl.Utf8),
...
MASSIVE_MINUTE_FEATURE_SCHEMA = ParquetSchema(
    name="massive_minute_derived_features",
    version=1,
    columns=(
        ("ticker", pl.Utf8),
        ("safe_ticker", pl.Utf8),
        ...
        ("late_30m_return", pl.Float64),
        ("late_60m_return", pl.Float64),
        ("late_60m_realized_var", pl.Float64),
        ("late_60m_up_semivar", pl.Float64),
        ("late_60m_down_semivar", pl.Float64),
        ("late_60m_skew", pl.Float64),
        ("late_60m_excess_kurtosis", pl.Float64),
        ("late_session_range", pl.Float64),
        ("late_volume_surge", pl.Float64),
        ("late_volume_zscore_20", pl.Float64),
        ("late_volume_percentile_20", pl.Float64),
        ("final_window_momentum", pl.Float64),
...
MASSIVE_OPTIONS_DAY_AGGS_FILTERED_SCHEMA = ParquetSchema(
    name="massive_options_day_aggs_filtered",
    version=1,
    columns=(
        ("bar_date_et", pl.Utf8),
        ("ticker", pl.Utf8),
...
MASSIVE_OPTIONS_ATM_IV_FEATURE_SCHEMA = ParquetSchema(
    name="massive_options_atm_iv_features",
    version=2,
    columns=(
        ("bar_date_et", pl.Utf8),
        ("feature_available_ts_utc", pl.Datetime("us", "UTC")),
        ("iv_method", pl.Utf8),
        ("risk_free_source", pl.Utf8),
        ("option_us_core_spy_atm_iv_short", pl.Float64),
        ("option_us_core_spy_atm_iv_medium", pl.Float64),
        ("option_us_core_spy_atm_iv_term_slope", pl.Float64),
        ("option_us_core_qqq_atm_iv_short", pl.Float64),
        ("option_us_core_qqq_atm_iv_medium", pl.Float64),
        ("option_us_core_qqq_atm_iv_term_slope", pl.Float64),
        ("option_us_core_dia_atm_iv_short", pl.Float64),
        ("option_us_core_dia_atm_iv_medium", pl.Float64),
        ("option_us_core_dia_atm_iv_term_slope", pl.Float64),
        ("option_us_core_iwm_atm_iv_short", pl.Float64),
        ("option_us_core_iwm_atm_iv_medium", pl.Float64),
        ("option_us_core_iwm_atm_iv_term_slope", pl.Float64),
        ("option_us_sector_median_atm_iv_short", pl.Float64),
        ("option_us_sector_median_atm_iv_medium", pl.Float64),
        ("option_us_sector_atm_iv_term_slope", pl.Float64),
        ("option_us_sector_atm_iv_dispersion_short", pl.Float64),
        ("option_us_sector_atm_iv_dispersion_medium", pl.Float64),
        ("option_us_sector_max_atm_iv_short", pl.Float64),
        ("option_us_sector_max_atm_iv_medium", pl.Float64),
        ("option_us_sector_valid_underlying_count_short", pl.Float64),
        ("option_us_sector_valid_underlying_count_medium", pl.Float64),
        ("option_japan_etf_ewj_atm_iv_short", pl.Float64),
        ("option_japan_etf_ewj_atm_iv_medium", pl.Float64),
        ("option_japan_etf_ewj_atm_iv_term_slope", pl.Float64),
        ("option_japan_etf_dxj_atm_iv_short", pl.Float64),
        ("option_japan_etf_dxj_atm_iv_medium", pl.Float64),
        ("option_japan_etf_dxj_atm_iv_term_slope", pl.Float64),
        ("option_japan_adr_median_atm_iv_short", pl.Float64),
        ("option_japan_adr_median_atm_iv_medium", pl.Float64),
        ("option_japan_adr_trimmed_mean_atm_iv_short", pl.Float64),
        ("option_japan_adr_trimmed_mean_atm_iv_medium", pl.Float64),
        ("option_japan_adr_atm_iv_term_slope", pl.Float64),
        ("option_japan_adr_valid_underlying_count_short", pl.Float64),
        ("option_japan_adr_valid_underlying_count_medium", pl.Float64),
        ("option_asia_proxy_median_atm_iv_short", pl.Float64),
        ("option_asia_proxy_median_atm_iv_medium", pl.Float64),
        ("option_asia_proxy_atm_iv_term_slope", pl.Float64),
        ("option_asia_proxy_max_atm_iv_short", pl.Float64),
        ("option_asia_proxy_max_atm_iv_medium", pl.Float64),
        ("option_asia_proxy_valid_underlying_count_short", pl.Float64),
        ("option_asia_proxy_valid_underlying_count_medium", pl.Float64),
    ),
    required_columns=("bar_date_et", "feature_available_ts_utc", "iv_method"),
)
