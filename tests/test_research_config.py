...
def test_core_feature_sets_exclude_short_history_and_robustness_tickers() -> None:
    ...
    assert config.feature_engineering.ml_feature_max_training_missingness == 0.17
    assert config.feature_engineering.ml_minute_feature_max_training_missingness == 0.17
    assert config.feature_engineering.ml_options_feature_max_training_missingness == 0.17
