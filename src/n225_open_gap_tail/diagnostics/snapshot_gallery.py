...
def _figure_key_readings(family: str) -> list[str]:
    readings = {
        "timing_design": [
            ...
            "- OSE schedule note: the night close changed from 05:30 to 06:00 JST for evening sessions starting 2021-09-21 (first extended close 2021-09-22), not in November 2024. The 2021-09-17 night session was suspended for the migration.",
