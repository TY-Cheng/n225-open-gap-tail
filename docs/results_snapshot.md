...
> **Research-candidate full-run artifact.** This page is generated from `tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc`.
...
| Field | Value |
| --- | --- |
| Run ID | `tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc` |
| Artifact root | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc` |
...
| Git commit | `e5e83abcc618919345eba0a3639afd4b7e87bbe3` |
| Git dirty | `True` |
...
| --- | --- | --- | --- | --- |
| `target_gap_histogram_density` | `target_distribution` | `panel/modeling_panel.parquet` | `target_distribution_motivation_not_forecast_validation` | `figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_gap_histogram_density.png` |
| `target_loss_qq_left_tail` | `left_tail` | `panel/modeling_panel.parquet` | `target_distribution_motivation_not_forecast_validation` | `figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_loss_qq_left_tail.png` |
| `target_loss_qq_right_tail` | `right_tail` | `panel/modeling_panel.parquet` | `target_distribution_motivation_not_forecast_validation` | `figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_loss_qq_right_tail.png` |
| `target_log_survival` | `left_right_target_distribution` | `panel/modeling_panel.parquet` | `target_distribution_motivation_not_forecast_validation` | `figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_log_survival.png` |
| `target_mean_excess` | `left_right_target_distribution` | `panel/modeling_panel.parquet` | `target_distribution_motivation_not_forecast_validation` | `figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_mean_excess.png` |
| `target_hill_plot` | `left_right_target_distribution` | `panel/modeling_panel.parquet` | `target_distribution_motivation_not_forecast_validation` | `figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_hill_plot.png` |
...
| FRED credit enriched | FRED credit enriched | 4 | 61.981% | 62.011% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| left promoted | LGBM median/IQR POT-GPD plain MLE | JP + US close core + JP proxy + Asia proxy | left_tail | 550 | 4.727% | 0.000904095 | -4.28605 | -0.00029175; p=0.006; reject10 | -0.669004; p=0.009; reject10 | in / in | pass |
| right promoted | LGBM location-scale empirical | JP + US close core + JP proxy | right_tail | 501 | 4.591% | 0.00104034 | -4.19543 | -0.000332236; p=0.064; reject10 | -0.865099; p=0.019; reject10 | in / in | pass |
...
| `ml_tail_metrics_per_model.parquet` | 56 | Per-model diagnostics on each model's own valid OOS rows | Not a cross-model comparison and not a replacement primary ML table. |
| `ml_tail_result_matrix.parquet` | 336 | Restricted common-sample VaR-only and VaR-ES comparisons | Restricted evidence; direct quantile rows here are comparison anchors. |
...
| ml_tail | LGBM POT-GPD UniBM block-maxima shape | JP only | 2 | 475 +/- 0 | 5.053% +/- 0.893% | 0.632% +/- 0.074% | 0.00143783 +/- 0.000162106 | -3.53744 +/- 0.0848569 | 0.0101719 +/- 0.000339824 |
| ml_tail | LGBM POT-GPD UniBM block-maxima shape | JP + US close core | 2 | 475 +/- 0 | 5.263% +/- 0.298% | 0.263% +/- 0.298% | 0.00113769 +/- 4.82773e-07 | -3.87968 +/- 0.0428254 | 0.00900382 +/- 0.00074143 |
| ml_tail | LGBM POT-GPD UniBM block-maxima shape | JP + US close core + JP proxy | 2 | 461 +/- 0 | 4.772% +/- 0.307% | 0.228% +/- 0.307% | 0.00105641 +/- 3.27898e-05 | -3.85701 +/- 0.240751 | 0.00883243 +/- 0.000269318 |
| ml_tail | LGBM POT-GPD UniBM block-maxima shape | JP + US close core + JP proxy + Asia proxy | 2 | 461 +/- 0 | 4.772% +/- 1.227% | 0.868% +/- 0.322% | 0.00108209 +/- 8.72544e-05 | -3.82555 +/- 0.468969 | 0.00931502 +/- 0.000187782 |
...
| ml_tail | LGBM median/IQR POT-GPD UniBM block-maxima shape | JP only | 2 | 577 +/- 0 | 4.073% +/- 0.123% | 0.927% +/- 0.123% | 0.00127115 +/- 0.000135686 | -3.75788 +/- 0.12724 | 0.0101841 +/- 0.000620908 |
| ml_tail | LGBM median/IQR POT-GPD UniBM block-maxima shape | JP + US close core | 2 | 577 +/- 0 | 5.546% +/- 0.735% | 0.546% +/- 0.735% | 0.00105265 +/- 9.82215e-05 | -4.01625 +/- 0.119394 | 0.00837685 +/- 0.000736627 |
| ml_tail | LGBM median/IQR POT-GPD UniBM block-maxima shape | JP + US close core + JP proxy | 2 | 550 +/- 0 | 5.364% +/- 0.129% | 0.364% +/- 0.129% | 0.00101325 +/- 0.000124856 | -3.95534 +/- 0.29025 | 0.00802305 +/- 0.00173135 |
| ml_tail | LGBM median/IQR POT-GPD UniBM block-maxima shape | JP + US close core + JP proxy + Asia proxy | 2 | 550 +/- 0 | 5.727% +/- 0.643% | 0.727% +/- 0.643% | 0.000997583 +/- 0.000131567 | -4.10478 +/- 0.244533 | 0.00716742 +/- 0.00120153 |
...
| --- | --- | --- | --- | --- | --- | --- |
| nested information sets | information_set_increment | var_coverage | 56 | 461 to 550 | 2023-03-24 to 2026-05-01 | 46 to 87 |
| nested information sets | information_set_increment | var_es_fz_loss | 56 | 461 to 550 | 2023-03-24 to 2026-05-01 | 46 to 87 |
| nested information sets | information_set_increment | var_quantile_loss | 56 | 461 to 550 | 2023-03-24 to 2026-05-01 | 46 to 87 |
| tail_model_family | model_family | var_coverage | 56 | 461 to 475 | 2023-09-08 to 2026-05-01 | 46 to 69 |
| tail_model_family | model_family | var_es_fz_loss | 56 | 461 to 475 | 2023-09-08 to 2026-05-01 | 46 to 69 |
| tail_model_family | model_family | var_quantile_loss | 56 | 461 to 475 | 2023-09-08 to 2026-05-01 | 46 to 69 |
...
- The implemented ML-tail registry is `LGBM direct quantile`, `LGBM location-scale empirical`, `LGBM POT-GPD plain MLE`, `LGBM POT-GPD UniBM block-maxima shape`, `LGBM median/MAD POT-GPD plain MLE`, `LGBM median/IQR POT-GPD plain MLE`, `LGBM median/IQR POT-GPD UniBM block-maxima shape`, but the primary nested-information-set comparison should be read only from `ml_tail_metrics.parquet`.
...
- Coverage warning: all `8` primary ML rows exhibit VaR breach rates (`0.0763636` to `0.127273`) that exceed the nominal level by more than 2.5 percentage points. Quantile-loss and FZ-loss differences across the nested information sets must be interpreted in this context; lower loss scores may partly reflect less conservative VaR estimates rather than better conditional tail calibration.
...
- `ml_tail_result_matrix.parquet` contains restricted common-sample comparisons for `7` LightGBM tail-model families.
- The restricted common-N range is `461 to 550` and the joint-exception range is `46 to 87`.
...
- The tail-model family comparison is severely sample-limited: the largest restricted common-N is `475` rows. No model-family ranking claim is supportable from this restricted sample; extended OOS coverage is needed before tail-model family ranking becomes meaningful.
- Result-matrix inference is recorded separately from the primary suite-level DM/MCS: restricted DM records include `180` gate-pass rows and `90` unavailable rows; restricted MCS records include `112` gate-pass rows and `56` unavailable rows. These entries are restricted common-sample diagnostics, not primary model-family rankings.
...
- Model-eviction artifacts record `8` retained rows and `48` non-retained rows under the primary ML sample policy.
...
- ES severity diagnostics contain `76` finite rows with mean exceedance severity ranging from `0.0058618` to `0.0127453`; this is conditional-on-exception evidence.
- The diagnostic 75th-percentile VaR trigger rule marks `12609` model-date rows; `875` of those rows coincide with VaR exceptions out of `3007` total exceptions, and mean triggered exception severity is `0.0141996`. This is a pre-open risk-monitoring diagnostic, not hedge PnL, transaction-cost, or trading-alpha evidence.
- Stress-window diagnostics contain `354` rows, and Murphy diagnostics contain `1600` ML-tail rows.
- Feature-unavailability diagnostics contain `224` rows.
...
![target_gap_histogram_density](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_gap_histogram_density.png)
...
![target_loss_qq_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_loss_qq_left_tail.png)
...
![target_loss_qq_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_loss_qq_right_tail.png)
...
![target_log_survival](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_log_survival.png)
...
![target_mean_excess](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_mean_excess.png)
...
![target_hill_plot](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_hill_plot.png)
...
![coverage_breach_rates_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/coverage_breach_rates_left_tail.png)
...
![coverage_breach_rates_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/coverage_breach_rates_right_tail.png)
...
![selected_model_performance_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/selected_model_performance_left_tail.png)
...
![selected_model_performance_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/selected_model_performance_right_tail.png)
...
![benchmark_murphy_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/benchmark_murphy_left_tail.png)
...
![benchmark_murphy_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/benchmark_murphy_right_tail.png)
...
![ml_tail_murphy_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/ml_tail_murphy_left_tail.png)
...
![ml_tail_murphy_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/ml_tail_murphy_right_tail.png)
...
![es_severity_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/es_severity_left_tail.png)
...
![es_severity_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/es_severity_right_tail.png)
...
![trigger_diagnostics_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/trigger_diagnostics_left_tail.png)
...
![trigger_diagnostics_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/trigger_diagnostics_right_tail.png)
...
![evt_standardized_hill_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_hill_left_tail.png)
...
![evt_standardized_log_survival_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_log_survival_left_tail.png)
...
![evt_standardized_mean_excess_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_mean_excess_left_tail.png)
...
![evt_standardized_qq_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_qq_left_tail.png)
...
![evt_standardized_threshold_stability_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_threshold_stability_left_tail.png)
...
![evt_standardized_hill_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_hill_right_tail.png)
...
![evt_standardized_log_survival_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_log_survival_right_tail.png)
...
![evt_standardized_mean_excess_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_mean_excess_right_tail.png)
...
![evt_standardized_qq_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_qq_right_tail.png)
...
![evt_standardized_threshold_stability_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/evt_standardized_threshold_stability_right_tail.png)
...
![dst_attenuation_left_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/dst_attenuation_left_tail.png)
...
![dst_attenuation_right_tail](figures/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/dst_attenuation_right_tail.png)
...
| --- | --- | --- |
| manifest | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/manifest.json` | yes |
| data_vintage | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/data_vintage.json` | yes |
| modeling_panel | `data/gold/tp/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/modeling_panel.parquet` | yes |
| target_audit | `data/gold/tp/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/target_audit.parquet` | yes |
| calendar_map | `data/gold/tp/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/calendar_map.parquet` | yes |
| feature_coverage | `data/gold/tp/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/feature_coverage.parquet` | yes |
| leakage_summary | `data/gold/ls/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/summary.json` | yes |
| benchmark_status | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/benchmark_status.json` | yes |
| benchmark_metrics | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/benchmark_metrics.parquet` | yes |
| benchmark_metrics_per_model | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/benchmark_metrics_per_model.parquet` | yes |
| benchmark_forecasts | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/forecasts/benchmark_forecasts.parquet` | yes |
| benchmark_dm_inference | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/benchmark_dm_inference.parquet` | yes |
| benchmark_mcs | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/benchmark_mcs.parquet` | yes |
| ml_tail_status | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_status.json` | yes |
| ml_tail_metrics | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_metrics.parquet` | yes |
| ml_tail_metrics_per_model | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_metrics_per_model.parquet` | yes |
| ml_tail_forecasts | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/forecasts/ml_tail_forecasts.parquet` | yes |
| ml_tail_result_matrix | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_result_matrix.parquet` | yes |
| ml_tail_result_matrix_dm | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_result_matrix_dm.parquet` | yes |
| ml_tail_result_matrix_mcs | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_result_matrix_mcs.parquet` | yes |
| ml_tail_dm_inference | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_dm_inference.parquet` | yes |
| ml_tail_mcs | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_mcs.parquet` | yes |
| ml_tail_cpa_inference | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_cpa_inference.parquet` | yes |
| cross_model_cpa_inference | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/cross_model_cpa_inference.parquet` | yes |
| ml_tail_model_eviction | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_model_eviction.parquet` | yes |
| ml_tail_dst_attenuation | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_dst_attenuation.parquet` | yes |
| ml_tail_murphy | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_murphy.parquet` | yes |
| ml_tail_feature_unavailability | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_feature_unavailability.parquet` | yes |
| benchmark_stress_windows | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/benchmark_stress_windows.parquet` | yes |
| ml_tail_stress_windows | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/metrics/ml_tail_stress_windows.parquet` | yes |
| figure_manifest | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/figure_manifest.json` | yes |
| table_manifest | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/table_manifest.json` | yes |
| latex_dir | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/tables` | yes |
| claim_scope_table | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/tables/tailrisk_claim_scope_table.tex` | yes |
| es_severity_table | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/tables/tailrisk_es_severity_table.tex` | yes |
| hedge_trigger_table | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/tables/tailrisk_hedge_trigger_diagnostics_table.tex` | yes |
| dst_attenuation_table | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/tables/ml_tail_dst_attenuation_table.tex` | yes |
| result_matrix_summary_table | `reports/runs/tailrisk_20160719_20260508_20260508T014502Z_commit_e5e83abc/latex/tables/ml_tail_result_matrix_summary_table.tex` | yes |
