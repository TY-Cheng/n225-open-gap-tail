...
This companion audit reports only the breach-neighborhood and sample-size gates. It is not the full 24-check audit; the Results Snapshot reports the breach, Kupiec, and Christoffersen independence checks across all eight scenarios.
