...
_require-external-data-paths: _require-external-uv-env
    python3 scripts/check_external_data_paths.py

status: _require-external-data-paths
    {{cli}} status
...
_run start="2016-07-19" end="" workers="" suite="all" force="false" tail_side="both" no_resume="false": _require-external-data-paths
...
_export-tables run_id="": _require-external-data-paths
    {{cli}} export-tables {{ if run_id == "" { "" } else { "--run-id \"" + run_id + "\"" } }}

_leakage-check run_id="": _require-external-data-paths
